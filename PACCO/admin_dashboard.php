...
class SidebarService
{
    ...
    {
        $items = [
            ['icon' => 'fa-home', 'label' => 'Dashboard', 'view' => 'dashboard', 'roles' => ['admin', 'superadmin', 'pgdh_gso', 'pgdh_pacco']],
            ['icon' => 'fa-truck', 'label' => 'Equipment', 'view' => 'equipment', 'roles' => ['admin', 'superadmin', 'pgdh_gso', 'pgdh_pacco']],
            ['icon' => 'fa-file-invoice', 'label' => 'Documents', 'view' => 'documents', 'roles' => ['admin', 'superadmin', 'pgdh_gso', 'pgdh_pacco']],
            ['icon' => 'fa-chart-pie', 'label' => 'Reports', 'view' => 'report', 'roles' => ['admin', 'superadmin', 'pgdh_gso', 'pgdh_pacco']],
        ];
...
if (empty($_SESSION['user_id']) || !in_array($_SESSION['role'] ?? '', ['admin', 'pgdh_gso', 'pgdh_pacco'])) {
        ...
        <div class="sidebar-brand">
            <div class="flex flex-col items-center space-y-3">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-xs font-medium text-purple-300 uppercase tracking-wider">PGDH-PACCO Panel</span>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="hidden lg:block">
                ...
                <div class="text-sm text-white">
                    here's the overview of PACCO department from the last 7 days
                </div>
            </div>
        </div>
        <!-- Center: Search Bar -->

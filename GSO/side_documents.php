...
<script>
    ...
    function addToMaintenanceFromModal() {
        ...
        // Check materials - at least one must have a value
        ...
        let errors = [];
        if (!attachedFile) errors.push('Attached File (Missing PDF/Photo proof)');
        ...
        if (!hasMaterial) errors.push('At least one Material/Part');

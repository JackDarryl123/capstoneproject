...
<script>
    ...
    function filterByLocation(location) {
        ...
        // If your system uses AJAX loading (loadView), call it:
        if (typeof loadView === 'function') {
            const viewParam = url.searchParams.get('view') || 'report';
            loadView(`${viewParam}&location=${location}&tab=${currentTab}`);
        } else {
            // Fallback to standard reload if not in AJAX environment
...
<?php
// ✅ Database connection will be closed by the parent script (admin_dashboard.php)
?>
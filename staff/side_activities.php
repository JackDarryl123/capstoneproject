        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 h-full flex flex-col">
            ...
            <div class="border-t border-gray-100 pt-6">
                ...
                <div class="flex justify-between items-center mb-4">
                    <h4 class="font-bold text-gray-800 text-lg">Next 7 Days</h4>
                    ...
                    <?php else: ?>
                        <?php foreach ($upcoming_events as $event):
                            ...
                            <div onclick="showActivityDetailsSide(<?= $event['id'] ?>)"
                                class="group flex gap-3 p-4 rounded-xl border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/50 transition-all duration-200 cursor-pointer shadow-sm hover:shadow-md">

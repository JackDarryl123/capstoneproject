...
<body>
    ...
    <script>
        // Wrap in IIFE to prevent variable redeclaration errors when loaded via AJAX
        (function() {
        ...
        window.redirectToEquipment = redirectToEquipment;
        ...
        window.redirectFromModal = redirectFromModal;

    ...
    <div class="min-h-screen py-10 px-4 sm:px-6 lg:px-8 no-print">
        ...
        <div class="max-w-7xl mx-auto mb-8 flex items-center justify-between">
            <div>
                ...
                <!-- <h1 class="text-3xl font-bold text-white-900">Equipment Details</h1> -->
                 <h1 class="text-3xl font-bold text-white">Equipment Details</h1>
            </div>
            ...
            <div class="lg:col-span-7">
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden h-full">
                    <div class="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/30">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Maintenance History</h3>
    ...
    <div id="docModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content shadow-2xl">
                ...
                <div class="modal-header bg-primary text-white d-flex justify-content-between align-items-center px-4 py-3"
                    ...
                    <button type="button" onclick="closeDocumentModal()"
                        class="text-white hover:text-gray-200 bg-transparent border-0" style="font-size: 1.5rem;">

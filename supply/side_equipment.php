...
if (isset($_POST['add_category'])) {
    ...
    header("Location: supply_dashboard.php?view=equipment");
    exit();
}
...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
    <div>
        <h2 class="text-gray-700 md:text-2xl font-bold">MANAGE AND VIEW ALL EQUIPMENTS</h2>
    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="hidden md:flex items-center space-x-6">
            <div class="text-center">
                <p class="text-xs text-gray-500 uppercase tracking-wider">Total Equipment</p>
                <?php
            ...
            <div class="text-center">
                ...
                ?>
                <p class="text-2xl font-bold text-gray-800"><?php echo $cat_count; ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <!-- <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <h2 class="text-lg font-semibold text-gray-800">All Equipment</h2>
                <div class="flex items-center space-x-4">
...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <form method="post" action="load_content.php?view=equipment">
...
<div class="modal fade" id="addEquipmentModal" tabindex="-1" aria-labelledby="addEquipmentModalLabel"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <form method="post" action="load_content.php?view=equipment" class="needs-validation" novalidate>
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <div class="p-6">
                            ...
                            <!-- Last Repair Date -->
                            <div class="mb-5">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Last Repair
                                    Date</label>

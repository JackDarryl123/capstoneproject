...
if (isset($_POST['login'])) {
    ...
    // Fetch user data
    $stmt = $mysqli->prepare("SELECT id, username, password, role, location, status, failed_attempts, lockout_time FROM users WHERE email = ?");
    ...
    switch ($user['role']) {
        case 'admin':
            header("Location: /PEPO/admin_dashboard.php");
            break;
        case 'staff':
            header("Location: /PEPO/staff/staff_dashboard.php");
            break;
        case 'supply':
            header("Location: /PEPO/supply/supply_dashboard.php");
            break;
        default:
            header("Location: /PEPO/users/user_dashboard.php");
            break;
    }
    exit();
}
...
//     $redirect = $_POST['redirect_to'] ?? 'profile.php';
    ...
    // ==========================================
// 🔹 PROFILE UPDATE (AJAX COMPATIBLE)
// ==========================================

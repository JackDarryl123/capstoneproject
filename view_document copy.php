...
if (isset($_POST['add_to_maintenance'])) {
    ...
    if ($stmt->execute()) {
        header("Location: http://localhost/PEPO/admin_dashboard.php?view=documents");
        exit();
    } else {
...
if (isset($_POST['complete'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: http://localhost/PEPO/admin_dashboard.php?view=maintenance");
        exit(); 
    } else {
...
if ($curr_user_id > 0) {
    ...
    if ($user_row = $sig_res->fetch_assoc()) {
        ...
        if (!empty($db_path)) {
            $my_signature = '/PEPO/' . ltrim($db_path, '/');
        }
    }
    $sig_stmt->close();
}
...
<body>
     ...
     <div class='document-container'>
        ...
        <div class='floating-buttons no-print'>
                ...
                <div class='timeline'>
                    <?php foreach ($status_steps as $step_key => $step): ?>
                        ...
                        <div class='timeline-item'>
                            <div class='timeline-dot <?= $dot_class ?><?= $is_completed ? ' completed' : '' ?><?= $is_current ? ' current' : '' ?>'></div>
            ...
            <div class='tip-box'>
                ...
                <small>
                    <i class='bi bi-lightbulb'></i>
                    Note: Click Send Request to Supply Department to notify a request to the supply department of your
                    request.
                </small>
                <br>
                <small>
                    <i class='bi bi-lightbulb'></i>
                    Note: Complete to notify the property costudian that request has been completed.
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="viewDocumentModal" tabindex="-1" aria-labelledby="viewDocumentModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-purple text-white" style="background: linear-gradient(135deg, #6f42c1 0%, #5a32a3 100%);">
                    <h5 class="modal-title" id="viewDocumentModalLabel">
                        <i class="bi bi-eye"></i> View Document - Pre-Repair No: <?= htmlspecialchars($doc['pre_repair_no'] ?? 'N/A') ?>
                    </h5>
                    ...
                    <div class="document-preview-container border rounded m-3" style="background: #f8f9fa;">
                        <div class="card p-4 shadow-sm border-0">
                            <header class="d-flex align-items-center justify-content-center mb-4 text-center">
                                ...
                                <img src="rs/BAGONG-PILIPINAS-LOGO.png" alt="Occidental Mindoro Logo" style="width:100px; height:auto; margin-left:15px;">
                            </header>
                            ...
                            <section class="mb-3">
                                ...
                                <div class="text-start mb-3 mt-2 d-flex align-items-center">
                                    <small class='fw-bold' style='white-space: nowrap; font-size: 16px;'>Pre-Repair No:</small>
                                    <span class="form-control form-control-sm signature-input bg-light" style="font-size: 14px;">
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">No materials/parts listed</td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <div class="border p-2 text-center">
                                            ...
                                            <div class="my-2" style="height: 60px;">
                                                <?php if (!empty($doc['inspected_by_sig'])): ?>
                                                    <img src="<?= htmlspecialchars($doc['inspected_by_sig']) ?>" style="height:50px; mix-blend-mode:multiply;">
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border p-2 text-center">
                                            ...
                                            <div class="my-2" style="height: 60px;">
                                                <?php if (!empty($doc['approved_by_pepo_sig'])): ?>
                                                    <img src="<?= htmlspecialchars($doc['approved_by_pepo_sig']) ?>" style="height:50px; mix-blend-mode:multiply;">
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="border p-2 text-center">
                                            ...
                                            <div class="my-2" style="height: 60px;">
                                                <?php if (!empty($doc['witnessed_by_sig'])): ?>
                                                    <img src="<?= htmlspecialchars($doc['witnessed_by_sig']) ?>" style="height:50px; mix-blend-mode:multiply;">
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border p-2 text-center">
                                            ...
                                            <div class="my-2" style="height: 60px;">
                                                <?php if (!empty($doc['approved_by_gso_sig'])): ?>
                                                    <img src="<?= htmlspecialchars($doc['approved_by_gso_sig']) ?>" style="height:50px; mix-blend-mode:multiply;">
                                                <?php endif; ?>
                                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="closeViewModalAndOpenSupply()">
    ...
    <!-- Supply Request Modal (unchanged) -->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="document-preview-container border rounded mb-4"
                            ...
                            <div class="card p-3 shadow-sm border-0 printable-area"
                                    ...
                                    <table class="table table-sm table-bordered mb-2 align-middle">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 12px;"><input type="text"
                                                        class="form-control form-control-sm border-0 bg-transparent"
                                                        value="<?= htmlspecialchars($doc['acquisition_date']) ?>"
                                                        readonly></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="font-size: 12px;"><input type="text"
                                                        class="form-control form-control-sm border-0 bg-transparent"
                                                        value="<?= htmlspecialchars($doc['acquisition_cost']) ?>"
                                                        readonly></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="font-size: 12px;"><input type="text"
                                                        class="form-control form-control-sm border-0 bg-transparent"
                                                        value="<?= htmlspecialchars($doc['last_repair_date']) ?>"
                                                        readonly></td>
                                            </tr>
                                            <tr>
                                ...
                                <!-- PRE-REPAIR INSPECTION SECTION -->
                                <section class="mb-3">
                                    <h5 class="text-center fw-bold bg-success text-white py-2"
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="defect" class="form-control form-control-sm signature-input"
                                            rows="2" readonly
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="findings" class="form-control form-control-sm signature-input"
                                            rows="2" readonly
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div style="font-size: 11px;">
                                            <input type="radio" name="recommendation" value="For In-House Repair"
                                                <?= ($doc['recommendation'] ?? '') === 'For In-House Repair' ? 'checked' : '' ?>
                                                disabled style="transform: scale(0.8);"> For In-House Repair
                                            <input type="radio" name="recommendation" value="For Outside Repair"
                                                <?= ($doc['recommendation'] ?? '') === 'For Outside Repair' ? 'checked' : '' ?>
                                                disabled style="transform: scale(0.8);"> For Outside Repair
                                        </div>
                                    </div>
                                </section>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 11px; padding: 2px;">
                                                    <input type="text" name="material_<?= $i ?>"
                                                        ...
                                                        value="<?= htmlspecialchars($doc["material_$i"] ?? '') ?>"
                                                        readonly style="font-size: 11px; padding: 2px;">
                                                </td>
                                                <td style="font-size: 11px; padding: 2px;">
                                                    <input type="text" name="quantity_<?= $i ?>"
                                                        class="form-control form-control-sm text-center border-0 bg-transparent"
                                                        value="<?= htmlspecialchars($doc["quantity_$i"] ?? '') ?>"
                                                        readonly style="font-size: 11px; padding: 2px;">
                                                </td>
                                            </tr>
                                            <?php endfor; ?>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body text-center p-0' style='background: #1a1a1a; min-height: 50vh;'>
                    <div class='photo-controls mb-2'>
                        <button class='btn btn-sm btn-outline-light' onclick='zoomPhoto(0.1)'><i class='bi bi-zoom-in'></i></button>
                        <button class='btn btn-sm btn-outline-light' onclick='zoomPhoto(-0.1)'><i class='bi bi-zoom-out'></i></button>
                        <button class='btn btn-sm btn-outline-light' onclick='resetZoom()'><i class='bi bi-arrow-counterclockwise'></i></button>
                    </div>
                    <img id='modalPhoto' src='' alt='Full Size Photo' style='max-width: 100%; max-height: 70vh; transition: transform 0.2s ease;'>
                </div>
                <div class='modal-footer' style='background: #1a1a1a; border: none;'>
                    <a id='downloadPhoto' href='' class='btn btn-success' download target='_blank'><i class='bi bi-download'></i> Download</a>
                    <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Close</button>
                </div>
            </div>
        </div>
